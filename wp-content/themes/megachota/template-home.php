      ...
      <div class="col-main">
        <section class="post-main" role="main" id="content">
			...
			if( ($hide_section != '1' && $hide_section != 'on') || ( function_exists('is_customize_preview') && is_customize_preview() )){
				...
				//renombro section, para que no salga el puto video "section"
				$section_css_class .= ' section__gue banner-main home-section-'.$onetone_section_id;
